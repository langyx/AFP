...
Imaginez que vous créez une sorte d’application pour surveiller la localisation d'un utilisateur. Créez une structure `GPS` avec deux propriétés variables, `latitude` et `longitude`, toutes deux avec des valeurs par défaut de 0.0.
 */
